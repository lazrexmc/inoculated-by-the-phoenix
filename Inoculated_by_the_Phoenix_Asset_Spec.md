...
9. **The crack is ONE wound in reality.** It first appears with the **first lightning strike of *Fear Inoculum* (~0:18–0:19)** — as the newborn world solidifies in the flash, not at the opening chimes (those are pure creation) — reopens at the end of *Culling Voices*, and the Phoenix flies into it in *7empest*. The hairline fracture in the *sealed sphere* during 7empest is a **separate** thing (a seal failing) and must look different from the creation-seam.
...
| `FX_CreationSeam_Crack` | The ONE wound in reality; appears at the L1 lightning (~0:18–0:19), reopens end of Culling Voices, entered in 7empest | Houdini/Blender | 4 |
