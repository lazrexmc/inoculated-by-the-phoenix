...
| File | Role |
|---|---|
| `mastershotlist.md` | **Master shot list** (authoring source). Canon-locked to Treatment v5; per-shot blocks whose fields map to the Excel columns. **Acts I–IV drafted** (unit-audited); Acts V & VII to come (VI/CCT deferred). |
